  ...
  return (
    <header className="border-b border-surface-border bg-[#0a0f1d]/90 backdrop-blur-md sticky top-0 z-40">
      ...
      <div className="max-w-[1720px] mx-auto px-4 sm:px-6 py-3 flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="font-extrabold text-base tracking-tight text-white">GOOD SHOWROOM</span>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-1.5 text-xs text-slate-400 hover:text-slate-200 bg-surface-card border border-surface-border px-3 py-1.5 rounded-lg transition-colors"
          >
            <HelpCircle className="w-3.5 h-3.5 text-slate-400" />
            <span>Metric Dictionary</span>
          </button>

          <div className="text-xs px-2.5 py-1 bg-surface-subtle border border-surface-border text-slate-400 font-mono rounded">
            AUD (ex-GST)
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#0e1526] border-t border-surface-border/60">
        <div className="max-w-[1720px] mx-auto px-4 sm:px-6 flex items-center gap-2 overflow-x-auto py-1.5">
          <span className="text-[11px] uppercase tracking-wider text-slate-400 font-semibold px-2">
            Role Altitude:
          </span>
            ...
            return (
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className={`text-[10px] leading-tight ${isActive ? 'text-blue-100' : 'text-slate-400'}`}>
                    {r.desc}
                  </div>
                </div>
              </button>
